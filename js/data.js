...
const AppState = {
  ...
  notifications: [
    ...
    { id: 4, type: 'task',     icon: 'bell',  title: '任務指派',                      message: '任務「整合測試」已指派給 測試工程師A，截止日期 2026/07/15',               time: '1天前',   read: true,  taskId: 4 },
    { id: 5, type: 'reminder', icon: 'clock', title: '專案截止提醒',                  message: '專案「行銷活動專案」將於 2026/06/30 截止，請確認各項任務進度',             time: '2天前',   read: true,  projectId: 2 },
    { id: 6, type: 'general',  icon: 'info',  title: '進度更新',                      message: '前端工程師A 已開始執行「APP 需求分析」，目前進度 10%',                    time: '3天前',   read: true,  taskId: 7 },
  ],
